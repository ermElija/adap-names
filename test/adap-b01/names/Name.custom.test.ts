...
describe("constructor tests", () => {
  /* it('comes with escaped characters', () => {
        const n = new Name(['a\\','b\.b', 'cde\\']);
        expect(n.asString()).equals('a\\.b\.b.cde\\');
    }); */
  /* it('does not double escape components', () => {
    const n = new Name(['a\\', 'b.b']);
    expect(n.getComponent(0)).to.equal('a\\');  // Sollte nur ein Backslash haben
    expect(n.getComponent(1)).to.equal('b\\.b'); // Nur ein Escape, nicht doppelt
}); */
});
